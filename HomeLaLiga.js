...
function HomeLaLiga() {
  ...
  const fetchData = () => {
    ...
    fetch("https://v3.football.api-sports.io/players/topscorers?season=2023&league=140", {
      "method": "GET",
      "headers": {
    ...
    fetch("https://v3.football.api-sports.io/standings?season=2023&league=140", {
      "method": "GET",
      "headers": {
        "x-rapidapi-host": "v3.football.api-sports.io",
        "x-rapidapi-key": "8fb089bd6a52cc4f974c33bfbc015551" // Asegúrate de usar tu propia clave de API
    ...
    fetch("https://v3.football.api-sports.io/players/topassists?season=2023&league=140", {
      "method": "GET",
      "headers": {
        "x-rapidapi-host": "v3.football.api-sports.io",
        "x-rapidapi-key": "8fb089bd6a52cc4f974c33bfbc015551" // Asegúrate de usar tu propia clave de API
    ...
    .then(response => response.json())
    .then(data => {
      const assistArray=data.response;
      console.log(assistArray);    
      setTopAssistProviders(assistArray);
    })
    .catch(err => {
      console.error(err);
    });
  ...
  return (
    <div className="home-container">
      <h1>Bienvenido a la página Home de La Liga</h1>
      ...
      <div className="top-scorers-container">
        <h2>Top Goleadores de La Liga</h2>
